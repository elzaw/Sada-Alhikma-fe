          ...
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                اهلا بك في صدي الحكمة 🦑
              </h2>

              <p className="mt-4 leading-relaxed text-white/90">
                هنا في صدى الحكمة، نسهل عليك طريق العمرة والحج، لنكون دليلك
                الموثوق نحو رحلة إيمانية مريحة ومليئة بالسكينة والاطمئنان.
              </p>
            </div>
          </section>
              ...
              >
                <div className="col-span-6 sm:col-span-6">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-xs py-2"
                  />
                  {errors.username && (
                ...
                <div className="col-span-6">
                  ...
                  <select
                    {...register("role", { required: "يرجى تحديد الدور" })}
                    className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-xs py-2"
                  >
